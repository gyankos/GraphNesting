...
\begin{document}
	...
	\draw[latex-latex] (a1.south) edge [bend right] node  [elabel,sloped] (c02) {\color{blue}coauthorship} (a3.south west) ;
	\draw[color=blue!80] (c02.south) -- (02c.north);
	\draw[color=blue!80] (c02.south) -- (02c.north east);
	
	\draw[latex-latex] (a3.south east) edge [bend right] node [elabel,sloped] (c21) {\color{blue}coauthorship} (a2.south) ;
